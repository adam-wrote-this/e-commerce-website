...
import { CATEGORY_OPTIONS, COLLECTIONS_OPTIONS } from '@/app/constants'
        ...
        >
          ...
          <div className='flex flex-col gap-3'>
            {CATEGORY_OPTIONS.items.map((category) => (
              <Link href={category.href} key={category.name} variant='gray'>
                {category.name}
              </Link>
            ))}
          </div>
        ...
        >
          ...
          <div className='flex flex-col gap-3'>
            {COLLECTIONS_OPTIONS.items.map((collection) => (
              <Link href={collection.href} key={collection.name} variant='gray'>
                {collection.name}
              </Link>
            ))}
          </div>
